...
<section>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="images/photos/user-avatar.png"> John Doe <b class="caret"></b></a>
                        <ul class="dropdown-menu">
   ...
   <div class="wrapper">
    ...
    <th>Sea Surface Temp</th>
                ...
                <tbody>               
                 <?php
if (($handle = fopen("elnino.csv", "r")) !== FALSE) {
